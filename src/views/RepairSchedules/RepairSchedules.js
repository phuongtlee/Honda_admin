  ...
  useEffect(() => {
    const fetchRepairSchedules = async () => {
      try {
        ...
        // Sort the data based on statusCheck ('Chưa xác nhận' should come first)
        ...
        setTotalPages(Math.ceil(sortedData.length / schedulesPerPage)) // Set total pages for pagination
      } catch (error) {
