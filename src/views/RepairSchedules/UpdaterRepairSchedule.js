...
const UpdaterRepairSchedule = () => {
  ...
  const [repairSchedule, setRepairSchedule] = useState({
    ...
    carName: '',
    carType: '',
    date: '', // Giữ nguyên nhưng không hiển thị
    service: '',
    staff: '',
    totalPrice: '',
    uid: '',
    ...
    statusCheck: 'Chưa xác nhận', // Default status check
  })
  ...
  useEffect(() => {
    ...
    // Không cần định dạng ngày giờ vì không hiển thị
  ...
  const handleChange = (e) => {
    ...
    // Chỉ cập nhật khi không phải là "date"
  ...
  const handleSubmit = async (e) => {
    ...
    const updatedSchedule = {
      ...repairSchedule,
      // Giữ nguyên giá trị ngày giờ đã có
      ...
      >
        ...
        <CCardBody style={{ overflowY: 'auto', maxHeight: '70vh' }}>
          ...
          <CForm onSubmit={handleSubmit}>
            {/* Không hiển thị trường ngày giờ */}
            <CRow className="mb-3">
              <CCol sm={12}>
                <CFormSelect
                  label="Nhân viên"
