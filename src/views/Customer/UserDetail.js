...
const UserDetail = () => {
  ...
  // Chỉ hiển thị số điện thoại phía sau mã vùng, thay thế mã vùng +84 bằng số 0
  const formattedPhone = user.phone.replace(/^\+84/, '0'); // Thay thế mã vùng +84 bằng số 0
            ...
            <CCol xs={12} className="d-flex align-items-center justify-content-center">
              <div className="d-flex align-items-center">
                ...
                <div className="ms-3">
                  ...
                  <CRow className="mb-3">
                    <CCol xs={12}>
                      <strong>Số điện thoại:</strong> {formattedPhone}
                    </CCol>
                  </CRow>
                  <CRow className="mb-3">
                    <CCol xs={12}>
